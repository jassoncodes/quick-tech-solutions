...
export const WHYUS = [
  ...
  },
  {
    ...
    icon: "verified_user",
    image: "trust-and-reliability.jpg",
  },
  {
    id: generateId("Honesty & Transparency"),
    title: "Honesty & Transparency",
    description: "We believe in honest and transparent technical support for our clients around Miami-Dade. You’ll always receive clear explanations, upfront pricing, and straightforward recommendations—no hidden costs or unnecessary services.",
    icon: "forum",
    image: "honesty-and-transparency.png",
  },
  {
    ...
    icon: "payments",
    image: "fair-clear-prices.png",
  },
];

export const CITIES = ["Kendall", "Kendall West", "East Kendall", "The Hammocks", "Kendale Lakes", "The Crossings", "Country Walk", "Pinecrest", "Coral Gables", "South Miami", "Coconut Grove", "Doral", "Sweetwater"];
